  ...
  return (
    <div className="relative font-body bg-deep-space text-cloud-white">
      ...
      <div className="relative w-full">
        ...
        {/* APPLICATIONS */}
        <section id="applications-section" className="w-full min-h-screen flex flex-col relative overflow-hidden bg-deep-space">
          {/* Background Image */}
          <div
            className="absolute inset-0 bg-cover bg-center"
          ...
          <div className="relative z-10 pt-20 pb-6 flex justify-center">
            <h2 className="font-heading text-3xl md:text-4xl font-bold uppercase tracking-widest text-center text-cloud-white drop-shadow-lg">
              Applications
            </h2>
          </div>
          ...
          <div className="relative z-10 flex-1 overflow-hidden flex items-center justify-center">
            ...
            <div className="relative w-full max-w-3xl min-h-[300px]">
              <div className="absolute inset-0 flex items-start justify-center pt-12 animate-fade-loop-app delay-100">
                <div className="text-center px-6">
                  <h3 className="text-horizon-cyan text-xl md:text-2xl font-heading font-bold mb-2">Personal Air Vehicle</h3>
                  {/* Changed text from gray to bright white */}
              ...
              <div className="absolute inset-0 flex items-start justify-center pt-12 animate-fade-loop-app delay-200">
                <div className="text-center px-6">
                  <h3 className="text-horizon-cyan text-xl md:text-2xl font-heading font-bold mb-2">Urban Air Taxi</h3>
                  {/* Changed text from gray to bright white */}
                  <p className="text-sm md:text-base text-white leading-relaxed drop-shadow-md">
              ...
              <div className="absolute inset-0 flex items-start justify-center pt-12 animate-fade-loop-app delay-300">
                <div className="text-center px-6">
                  <h3 className="text-horizon-cyan text-xl md:text-2xl font-heading font-bold mb-2">Air Ambulance Variant</h3>
                  {/* Changed text from gray to bright white */}
                  <p className="text-sm md:text-base text-white leading-relaxed drop-shadow-md">
              ...
              <div className="absolute inset-0 flex items-start justify-center pt-12 animate-fade-loop-app delay-400">
                <div className="text-center px-6">
                  <h3 className="text-horizon-cyan text-xl md:text-2xl font-heading font-bold mb-2">Special Mission Configurations</h3>
                  {/* Changed text from gray to bright white */}
                  <p className="text-sm md:text-base text-white leading-relaxed drop-shadow-md">
